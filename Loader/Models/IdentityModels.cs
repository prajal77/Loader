...
namespace Loader.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, Role,int, AppUserLogin, AppUserRole, AppUserClaim>
    {
        ...
        public DbSet<MasterUnitOfMeasure> MasterUnitOfMeasure { get; set; }
        public DbSet<BranchDetails> BranchDetails { get; set; }
        public DbSet<LevelAuthority> LevelAuthority { get; set; }
        public DbSet<ItemType> ItemType { get; set; }
        public DbSet<CategoryMaster> CategoryMaster { get; set; }
        public DbSet<RequestMain> RequestMain { get; set; }
        public DbSet<RequestDetails> RequestDetails { get; set; }
        public DbSet<ManifactureMaster> ManifactureMaster { get; set; }
        public DbSet<MasterBrand> MasterBrand { get; set; }
        public DbSet<MasterModel> MasterModel { get; set; }
        public DbSet<ItemMaster> ItemMaster { get; set; }
        public DbSet<StoreTransferMain> StoreTransferMain { get; set; }
        public DbSet<StoreTransferDetails> StoreTransferDetails { get; set; }
        public DbSet<BusinessUnitDetails> BusinessUnitDetails { get; set; }
        public DbSet<PurposeTypeMaster> PurposeTypeMaster { get; set; }
        public DbSet<InvestmentCodeDetails> InvestmentCodeDetails { get; set; }
        public DbSet<StoreTransferItemDetails> StoreTransferItemDetails { get; set; }
        public DbSet<ReturnItemDetails_SerialMac> ReturnItemDetails_SerialMac { get; set; }
        public DbSet<MasterLocation> MasterLocation { get; set; }
        public DbSet<CustomerTypes> CustomerTypes { get; set; }
        public DbSet<MasterGrade> MasterGrade { get; set; }
        ...
        protected override void OnModelCreating(System.Data.Entity.DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RequestMain>().ToTable("RequestMain", "dbo");
        }
    }
}