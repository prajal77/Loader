...
function ShowCalanderRange(html, left, top, dtype) {
    ...
    $calanderDialogRnge.setAttribute("class", "dialog_calander panel panel-default1");
...
$(document).on('click', '.chCloseReg', function () {
    CloseCalanderDialogRange();
});

$('.dpCalBtnRange').on('click', function (e) {
    ...
    var DType = _dtObject.find('.calDateTypeRange').attr("id");
    ...
    if (windowwidth - pos.left < 520) {
        left = windowwidth - 520;
    }
    else {
        left = pos.left;
    }
    if (windowheight - pos.top < 382) {
        top = pos.top - 378;
    }
    else {
        top = pos.top -289;
...
$(document).on('click', '.fc-button-prevRange', function () {
    var dType = _dtObject.find('.calDateTypeRange').attr("id");
...
$(document).on('click', '.fc-button-nextRange', function () {
...
$(document).on('click', '.fc-button-prevRange1', function () {

    var dType = _dtObject.find('.calDateTypeRange').attr("id");
    var mn = $(this).parents('.dialog_calander').find("#MonthTo").val();
    var yr = $(this).parents('.dialog_calander').find("#YearTo").val();
    var mindays = $(this).parents('.dialog_calander').find("#MinDate").val();
...
$(document).on('click', '.fc-button-nextRange1', function () {
...
$(document).on('click', '.calanderDayRange', function (e) {
    ...
    var fromDateAd = $(this).parents('.dialog_calander').find(".fc-header-title").find(".fromDateAd");
    var fromDateBs = $(this).parents('.dialog_calander').find(".fc-header-title").find(".fromDateBs");
    var toDateAd = $(this).parents('.dialog_calander').find(".fc-header-title").find(".toDateAd");
    var toDateBs = $(this).parents('.dialog_calander').find(".fc-header-title").find(".toDateBs");
    var engDateFrom = $(this).parents('.dialog_calander').find(".fc-header-title").find("#EnglishDateFrom");
    var engDateTo = $(this).parents('.dialog_calander').find(".fc-header-title").find("#EnglishDateTo");
    var minDate = $(this).parents('.dialog_calander').find(".fc-header-title").find("#MinDate");
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            me.parents('.dialog_calander').find("#MonthTo").val(month);
            me.parents('.dialog_calander').find("#YearTo").val(year);
...
$(document).on('click', '.calanderDayRange1', function (e) {
    ...
    var month; var year; var dType;
    SelectedDay = $(this).attr("id");
    var month = $(this).parents('.dialog_calander').find("#MonthTo").val();
    var year = $(this).parents('.dialog_calander').find("#YearTo").val()
    ...
    var engDateFrom = $(this).parents('.dialog_calander').find(".fc-header-title").find("#EnglishDateFrom");
    var engDateTo = $(this).parents('.dialog_calander').find(".fc-header-title").find("#EnglishDateTo");
    dType = _dtObject.find('.calDateTypeRange').attr("id");
    var maxDate = $(this).parents('.dialog_calander').find(".fc-header-title").find("#Maxdate");
    var me = $(this);
    //var ADCntrl = _dtObject.find('.txtDateADRange');
    //var BSCntrl = _dtObject.find('.txtDateBSRange')
    //var DTCntrl = _dtObject.find('.txtDateValueRange')
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            // DateChangedFunctionRange(_dtObject);
            me.parents('.dialog_calander').find("#Months").val(month);
            me.parents('.dialog_calander').find("#Years").val(year)
...
$(document).on('click', '.Apply', function () {
    ...
    $('.dialog_calander').fadeOut(300);
    var fromDateAd = $(this).parents('.dialog_calander').find(".fc-header-title").find(".fromDateAd").val();
    var fromDateBs = $(this).parents('.dialog_calander').find(".fc-header-title").find(".fromDateBs").val();
    var toDateAd = $(this).parents('.dialog_calander').find(".fc-header-title").find(".toDateAd").val();
    var toDateBs = $(this).parents('.dialog_calander').find(".fc-header-title").find(".toDateBs").val();
    var engDateFrom = $(this).parents('.dialog_calander').find(".fc-header-title").find("#EnglishDateFrom").val();
    var engDateTo = $(this).parents('.dialog_calander').find(".fc-header-title").find("#EnglishDateTo").val();
...
$(document).on('change', '.yearMonthTo', function (e) {
    ...
    var mn = $(this).parents('.dialog_calander').find("#MonthTo").val();
    var yr = $(this).parents('.dialog_calander').find("#YearTo").val();
    var maxdays = $(this).parents('.dialog_calander').find("#MinDate").val();
    var current = $(this);
    var type = 2;
    DateRageForYearMonthChange(yr, mn, dType, current, type, maxdays);
});

$('.calDateTypeRange').on("click", function () {
...
function SetDateRangeValue(dtObject, dtValue, type) {
    ...
    var DType = dtObject.parents('.dialog_calander').find('.BsAdRange option:selected').val()
    var Date;

    if (type == 1) {
        Date = formatDate(dtObject.parents('.dialog_calander').find(".fc-header-title").find("#EnglishDateTo").val());

    } else {
        Date = formatDate(dtObject.parents('.dialog_calander').find(".fc-header-title").find("#EnglishDateFrom").val())
    }

    var newDate; var result;

    var fromDate = dtObject.parents('.dialog_calander').find(".fc-header-title").find("#EnglishDateFrom");
    var toDate = dtObject.parents('.dialog_calander').find(".fc-header-title").find("#EnglishDateTo");
    var fromDateAd = dtObject.parents('.dialog_calander').find(".fc-header-title").find(".fromDateAd");
    var fromDateBs = dtObject.parents('.dialog_calander').find(".fc-header-title").find(".fromDateBs");
    var toDateAd = dtObject.parents('.dialog_calander').find(".fc-header-title").find(".toDateAd");
    var toDateBs = dtObject.parents('.dialog_calander').find(".fc-header-title").find(".toDateBs");
    var Istrue = false;
    $.ajax({
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (type == 1) {
                ...
                $(current).parents('.dialog_calander').find("#MonthTo").val(mn);
                $(current).parents('.dialog_calander').find("#YearTo").val(yr);
