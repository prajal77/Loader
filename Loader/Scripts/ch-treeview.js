...
$(document).ready(function () {
    ...
    $('.ch-treeview').unbind('keyup').bind('keyup','.text-filter-tree', function (event) {
        ...
        if (checkevent == 13) {
            ...
            if ($(findParent).length > 0) {
                ...
                var parentClass = $(activeClass).closest("li");
                ...
                var id = $(activeClass).attr("nodeid");
                var pid = $(activeClass).attr("nodepid");
                var text = $(activeClass).attr("nodetext");
                var isGroup = $(activeClass).attr("nodeisgroup");
                ...
                $(activeClass).toggleClass('treeview-selected');
    ...
    $('.treeview-area').on('click', '.treeview-text', function (e) {
        ...
        $(wrapperClass).trigger('nodeClick', [{ nodeId: id, parentNodeId: pid, nodeText: text, isGroup: isGroup, allowSelectGroupNode: allowSelectGroupNode,allowSelect:allowSelect }]);
