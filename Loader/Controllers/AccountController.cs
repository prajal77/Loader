...
namespace Loader.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model)
        {
            ...
            {
                ModelState.AddModelError("Error", "Please Fill Up Form.");
                return View(model);
            }
                ...
                if(this.IsCaptchaValid("Validate your captcha"))
                {
                    ...
                    switch (result)
                    {
                        case SignInStatus.Success:
                            ...
                            Session["BranchId"] = _usrVSBrnchService.GetCurrentBranchInt(user.Id);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, IsActive = true, IsUnlimited = model.IsUnlimited, EffDate = model.From, TillDate = model.To, EmployeeId = model.EmployeeId, PasswordHash = model.Password, MTId = model.MTId };
                ...
                {
                    return JavaScript(ModelState.Values.LastOrDefault().Errors.First().ErrorMessage.ToString());
                }
            }
            catch (Exception ex)
            {
